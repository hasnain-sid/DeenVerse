export const tazkiaTraits = [
    {
        slug: "tawakkul",
        title: "Tawakkul (Reliance on Allah)",
        arabicTitle: "توكل",
        primaryAyah: "65:3",
        primaryHadith: "If you were to rely upon Allah with the required reliance, then He would provide for you just as a bird is provided for, it goes out in the morning empty, and returns full. (Tirmidhi)",
        description: "Tawakkul is tying your camel and then leaving the outcome to Allah, finding peace in His ultimate plan.",
        muhasabaPrompts: [
            "Did I worry excessively about the future today?",
    ...
    },
    {
        ...
        arabicTitle: "صبر",
        primaryAyah: "2:153",
        primaryHadith: "Whoever tries to be patient, Allah will make him patient. And nobody can be given a better and greater gift than patience. (Bukhari)",
        description: "Sabr is not just passive waiting; it is active endurance, refraining from complaining, and maintaining composure for the sake of Allah.",
        muhasabaPrompts: [
            "When did I lose my temper or complain today?",
    ...
    },
    {
        ...
        arabicTitle: "شكر",
        primaryAyah: "14:7",
        primaryHadith: "He who does not thank people does not thank Allah. (Abu Dawud)",
        description: "Shukr is recognizing that every blessing comes from Allah, expressing it with the tongue, and using the blessing in a way that pleases Him.",
        muhasabaPrompts: [
            "Did I overlook a major blessing today because I am so used to it?",
    ...
    },
    {
        ...
        arabicTitle: "صدق",
        primaryAyah: "9:119",
        primaryHadith: "Truthfulness leads to righteousness, and righteousness leads to Paradise. A man keeps telling the truth until he is recorded with Allah as a truthful person. (Bukhari & Muslim)",
        description: "Sidq is truthfulness in speech, action, and intention — aligning what you say with what you do and what you believe.",
        muhasabaPrompts: [
            "Was there a moment today where I exaggerated, hid the truth, or was dishonest — even slightly?",
    ...
    },
    {
        ...
        arabicTitle: "إخلاص",
        primaryAyah: "98:5",
        primaryHadith: "Actions are judged by their intentions, and everyone will be rewarded according to what they intended. (Bukhari & Muslim)",
        description: "Ikhlas is doing everything purely for the sake of Allah, free from the desire for praise, recognition, or worldly gain.",
        muhasabaPrompts: [
            "Did I do any good deed today hoping someone would notice or praise me?",
    ...
    },
    {
        ...
        arabicTitle: "تواضع",
        primaryAyah: "25:63",
        primaryHadith: "No one humbles himself for the sake of Allah except that Allah elevates him. (Muslim)",
        description: "Tawadu' is recognizing your own reality, accepting the truth regardless of who it comes from, and not looking down on anyone.",
        muhasabaPrompts: [
            "Did I feel superior to anyone today because of knowledge, wealth, or righteousness?",
    ...
    {
        slug: "rahma",
        title: "Rahma (Mercy / Compassion)",
        arabicTitle: "رحمة",
        primaryAyah: "9:128",
        primaryHadith: "Have mercy on those on the earth, and the One in heaven will have mercy on you. (Tirmidhi)",
        description: "Rahma is having a soft heart towards creation, wishing good for them, and alleviating their suffering when possible.",
        muhasabaPrompts: [
            "Was I harsh with anyone (family members, workers, animals) today?",
    ...
    {
        slug: "afw",
        title: "'Afw (Forgiveness / Pardoning)",
        arabicTitle: "عفو",
        primaryAyah: "5:13",
        primaryHadith: "Be merciful to others and you will receive mercy. Forgive others and Allah will forgive you. (Musnad Ahmad)",
        description: "'Afw goes beyond forgiving — it is erasing the offense from your heart entirely, as if it never happened, out of generosity of spirit.",
        muhasabaPrompts: [
            "Am I holding a grudge against someone that is weighing on my heart?",
    ...
    {
        slug: "qanaa",
        title: "Qana'a (Contentment)",
        arabicTitle: "قناعة",
        primaryAyah: "20:131",
        primaryHadith: "Wealth is not having many possessions; true wealth is the richness of the soul. (Bukhari)",
        description: "Qana'a is finding peace with what Allah has decreed for you, not because you stop striving, but because you stop being enslaved by want.",
        muhasabaPrompts: [
            "Did I scroll through social media and feel envious of someone's life/wealth/appearance today?",
    ...
    {
        slug: "hilm",
        title: "Hilm (Forbearance)",
        arabicTitle: "حلم",
        primaryAyah: "3:134",
        primaryHadith: "The strong man is not the one who overcomes others by his strength, but the one who controls himself while in anger. (Bukhari)",
        description: "Hilm is the ability to remain calm, composed, and measured when provoked — responding with wisdom, not reacting with rage.",
        muhasabaPrompts: [
            "Was there a moment today I reacted in anger that I wish I could take back?",
    ...
    {
        slug: "wafa",
        title: "Wafa (Loyalty / Fulfilling Covenants)",
        arabicTitle: "وفاء",
        primaryAyah: "17:34",
        primaryHadith: "The signs of a hypocrite are three: when he speaks he lies, when he makes a promise he breaks it, and when he is entrusted he betrays. (Bukhari & Muslim)",
        description: "Wafa is honoring your commitments — to Allah, to people, to your own word. It is the opposite of treachery and broken promises.",
        muhasabaPrompts: [
            "Did I break any promise today, even a small one (being on time, a commitment to a friend)?",
    ...
    {
        slug: "hayaa",
        title: "Hayaa (Modesty / Shame before Allah)",
        arabicTitle: "حياء",
        primaryAyah: "24:30",
        primaryHadith: "Modesty is a branch of faith. (Muslim)",
        description: "Hayaa is an inner sense of shame that prevents you from disobeying Allah, whether in public or in private — not because of people, but because of awareness of Allah.",
        muhasabaPrompts: [
            "Did I do something in private that I would be ashamed of if others saw — and did I remember Allah sees?",
    ...
    {
        slug: "muraqaba",
        title: "Muraqaba (God-Consciousness / Watchfulness)",
        arabicTitle: "مراقبة",
        primaryAyah: "20:7",
        primaryHadith: "Ihsan is to worship Allah as though you see Him, and if you cannot see Him, He sees you. (Muslim)",
        description: "Muraqaba is living with constant awareness that Allah sees every action, hears every word, and knows every thought — and letting that awareness shape your behavior.",
        muhasabaPrompts: [
            "How many minutes today was I genuinely conscious of Allah's presence?",
    ...
    {
        slug: "zuhd",
        title: "Zuhd (Detachment from Dunya)",
        arabicTitle: "زهد",
        primaryAyah: "35:5",
        primaryHadith: "Be in this world as if you were a stranger or a traveler. (Bukhari)",
        description: "Zuhd is not poverty or deprivation — it is freedom. It is having the dunya in your hand but not in your heart, using it without being used by it.",
        muhasabaPrompts: [
            "What material thing am I most attached to? What would happen if I lost it?",
    ...
    {
        slug: "khushoo",
        title: "Khushoo (Humility in Worship)",
        arabicTitle: "خشوع",
        primaryAyah: "23:1-2",
        primaryHadith: "The worst thief is the one who steals from his prayer — he does not complete its ruku or sujud. (Musnad Ahmad)",
        description: "Khushoo is the presence of the heart in worship — standing before Allah with full attention, awe, and humility, not rushing through motions.",
        muhasabaPrompts: [
            "During my last prayer, how many seconds was my mind truly present with Allah?",
    ...
    {
        slug: "husn-al-dhann",
        title: "Husn al-Dhann (Good Opinion of Allah & People)",
        arabicTitle: "حسن الظن",
        primaryAyah: "49:12",
        primaryHadith: "Beware of suspicion, for suspicion is the worst of false tales. (Bukhari & Muslim)",
        description: "Husn al-Dhann is assuming the best about Allah's decree and about people's intentions — the opposite of cynicism, suspicion, and paranoia.",
        muhasabaPrompts: [
            "Did I assume the worst about someone's motives today without evidence?",
    ...
    {
        slug: "karam",
        title: "Karam (Generosity)",
        arabicTitle: "كرم",
        primaryAyah: "3:134",
        primaryHadith: "The upper hand (the giving hand) is better than the lower hand (the receiving hand). (Bukhari & Muslim)",
        description: "Karam is giving freely — not just wealth, but time, attention, and kindness — especially when it is difficult and when you fear scarcity.",
        muhasabaPrompts: [
            "Did I hold back from giving today out of fear of not having enough?",
    ...
    {
        slug: "adl",
        title: "'Adl (Justice / Fairness)",
        arabicTitle: "عدل",
        primaryAyah: "16:90",
        primaryHadith: "The just will be seated upon pulpits of light on the Day of Resurrection. (Muslim)",
        description: "'Adl is giving everyone — including yourself, your enemies, and your loved ones — exactly what they deserve, without bias, favoritism, or oppression.",
        muhasabaPrompts: [
            "Did I treat someone unfairly today because of my personal feelings towards them?",
    ...
    {
        slug: "mujahadah",
        title: "Mujahadah (Striving Against the Nafs)",
        arabicTitle: "مجاهدة",
        primaryAyah: "29:69",
        primaryHadith: "The mujahid is he who strives against his own nafs for the sake of Allah. (Tirmidhi)",
        description: "Mujahadah is the daily inner battle — resisting laziness, desires, and bad habits. It is choosing the harder right over the easier wrong, consistently.",
        muhasabaPrompts: [
            "What did my nafs demand today that I gave in to, knowing it was wrong?",
    ...
    {
        slug: "shajaa",
        title: "Shaja'a (Courage)",
        arabicTitle: "شجاعة",
        primaryAyah: "9:40",
        primaryHadith: "The best jihad is a word of truth before a tyrant ruler. (Abu Dawud & Tirmidhi)",
        description: "Shaja'a is courage — not the absence of fear, but acting upon truth despite fear. It is speaking up for what is right and standing firm when tested.",
        muhasabaPrompts: [
            "Was there a moment today when I stayed silent about something wrong because I feared people's reaction?",
