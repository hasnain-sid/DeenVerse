...
const RightSideBar = () => {
  ...
  return (
    <div className="flex flex-col">
      <div className="p-3 w-auto border-2 border-orange-400 ">
        ...
        <div className=" border-2 border-red-400 p-4 h-auto w-auto items-start bg-gray-100 rounded-2xl my-4  flex flex-col md:flex md:flex-row md:justify-center">
          <div
            className=" 
        mr-2 w-auto border-2 border-blue-400"
          >
            <Dropdown value={"Style"} data={fonts} type={"font"} />
          </div>
          <div className="mt-2  border-2 border-yellow-300 md:mt-0">
            <Dropdown
              value={"Language"}
              data={translations}
              type={"language"}
