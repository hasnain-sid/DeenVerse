...
const Daily = () => {
    ...
    const savedHandler =  (async (e) => {
        setClick(e);
        try {
            const res = await axios.put(`${USER_API_END_POINT}/saved/${id}`,{id:user?._id},{
                ...
                <div className="flex justify-between">
                    <div className=" flex  justify-evenly p-1">
                        <img
                            ...
                            // src="https://img.freepik.com/premium-photo/ornamental-arabic-l  antern-with-burning-candle-glowing-night-glittering-golden-bokeh-lights_597582-318.jpg"
                    ...
                    <div className="flex justify-between mt-8 mb-2  bg-cyan-300 rounded-full">
                        ...
                        <div className="flex items-center">
                            ...
                            {click ? <FaBookmark color="yellow" onClick={() => savedHandler(false)} /> : <FaRegBookmark color="black" onClick={() => savedHandler(true)} />}
